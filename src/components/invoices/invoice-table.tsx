...
import { defaultInvoiceFilters, useInvoicesList } from "@/hooks/use-invoices";
...
export function InvoiceTable() {
  ...
  return (
    <PageShell
      title="Invoices"
      description="Manage client billing, payments, and outstanding balances."
      actions={
        <>
          <Button
            variant="outline"
          ...
          <Button
            variant="outline"
            className="h-9"
            render={<Link href="/invoices/outstanding" />}
          >
            Outstanding
          </Button>
          <Button className="h-9" render={<Link href="/invoices/new" />}>
    ...
    >
      ...
      <DataTable
        ...
        errorMessage={
          isError
            ? "Couldn't load invoices. Refresh the page and try again."
            : null
        }
      />
    </PageShell>
